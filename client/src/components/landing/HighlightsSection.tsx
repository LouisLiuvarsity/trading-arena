...
export default function HighlightsSection() {
  ...
  const copy = lang === 'zh'
    ? {
        ...
        rulesTitle: '比赛规则',
        rulesDesc: '5,000U 模拟资金 · 最多 40 笔交易 · 24 小时赛制 · 至少 5 笔交易才有奖金资格',
        rulesItems: [
          { icon: Shield, text: '5,000 USDT 模拟资金，所有段位相同' },
          { icon: Zap, text: '最多 40 笔交易，鼓励精准决策' },
          { icon: DollarSign, text: '至少完成 5 笔交易才有奖金资格' },
        ],
        prizeTitle: '奖金池',
    ...
    : {
        ...
        rulesDesc: '5,000U simulated capital · Max 40 trades · 24h format · Min 5 trades to qualify',
        rulesItems: [
          { icon: Shield, text: '5,000 USDT simulated capital, same for all tiers' },
          { icon: Zap, text: 'Max 40 trades per match, rewarding precision' },
          { icon: DollarSign, text: 'Min 5 trades required for prize eligibility' },
        ],
