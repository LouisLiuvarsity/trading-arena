...
import { Shield, Activity, Trophy, Clock, DollarSign, Star } from 'lucide-react';

const RULES = [
  { icon: Shield,     color: '#F0B90B', key: 'card1' },
  { icon: Activity,   color: '#0ECB81', key: 'card2' },
  { icon: Trophy,     color: '#F0B90B', key: 'card3' },
  { icon: Clock,      color: '#0ECB81', key: 'card4' },
  { icon: DollarSign, color: '#F0B90B', key: 'card5' },
  { icon: Star,       color: '#0ECB81', key: 'card6' },
] as const;
