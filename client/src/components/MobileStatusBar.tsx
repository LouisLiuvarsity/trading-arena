// ============================================================
// Mobile Status Bar — Minimal: Home + Language + Countdown
// ============================================================
    ...
    <div className={`${getBarBg()} border-b border-[rgba(255,255,255,0.08)] transition-colors duration-1000`}>
      <div className="flex items-center justify-between px-2.5 py-1.5 text-[10px]">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button onClick={() => navigate('/hub')} className="text-[9px] text-[#848E9C] hover:text-[#D1D4DC] px-1 py-0.5 rounded bg-white/5 font-medium">{t('status.home')}</button>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className={`font-mono text-[11px] font-bold tabular-nums ${
            isLast15Min ? 'text-[#F6465D] animate-blink' : isLastHour ? 'text-[#FF6B35]' : isLast2Hours ? 'text-[#F0B90B]' : 'text-[#D1D4DC]'
          }`}>
